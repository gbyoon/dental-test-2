...
var regMemberInfo = require('./routes/admin/regMemberInfo');
var srchMemberInfoNasgn = require('./routes/admin/srchMemberInfoNasgn');
var asgnDentalToMem = require('./routes/admin/asgnDentalToMem');
var srchMemberInfoAsgn = require('./routes/admin/srchMemberInfoAsgn');
